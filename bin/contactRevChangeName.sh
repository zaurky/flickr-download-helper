...
cat $FLICKRDIR/files/contacts_rev_name.new | sort > $FLICKRDIR/files/contacts_rev_name.old
$FLICKRBINDIR/getContacts.py --gcf nsid,username | sort > $FLICKRDIR/files/contacts_rev_name.new
